			...
			<div class="navbar-inner">
				<div class="container">
					...
					<div class="nav-collapse collapse">
						<ul class="nav">
							<li {{ (Request::is('/') ? 'active' : '') }}><a href="{{{ URL::to('') }}}">Home</a></li>
						</ul>
			                        ...
			                        <ul class="nav pull-right">
			                            ...
			                            @else
			                            <li {{ (Request::is('user/login') ? 'active' : '') }}><a href="{{{ URL::to('user/login') }}}">Login</a></li>
			                            <li {{ (Request::is('user/register') ? 'active' : '') }}><a href="{{{ URL::to('user/create') }}}">Sign Up</a></li>
			                            @endif
			                        </ul>
					</div>
					<!-- ./ nav-collapse -->
